...
export default async function Home() {
  const debugEnabled = isDebugEnvEnabled();
  
  // In debug mode, always show the landing page for manual role selection
  if (debugEnabled) {
    return (
