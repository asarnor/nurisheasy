...
// Accept/Decline/Cancel are handled by dedicated endpoints.
 ...
 * - Debug mode: unrestricted transitions (used by mock KDS).
 * - Production: vendor-authenticated. Only the owning vendor may update their
 *   sub-order, and only to PREPARING / READY / DELIVERED.
 */
